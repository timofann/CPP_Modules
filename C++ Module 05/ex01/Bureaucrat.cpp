...
void Bureaucrat::signForm(Form &f) {
	if (f.isSigned())
		std::cout << this->name_ << " couldn’t sign " << f.getName()
...
Bureaucrat::GradeTooHighException::GradeTooHighException() :
	std::out_of_range("\033[3;31mThe highest grade is 1\033[0m") {};

Bureaucrat::GradeTooLowException::GradeTooLowException() :
	std::out_of_range("\033[3;31mThere is no grade lower than 150\033[0m") {};
